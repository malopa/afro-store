...
const data = [
    {id:1,name:"watch one then we will limit later",price:2000,
    img:require('../../assets/pic1.jpeg')},
    {id:2,name:"Serenium watch let put all content in full",
    price:2000,img:require('../../assets/pic2.jpeg')},
    {id:3,name:"Digital watch, walk smart",price:2000,img:require('../../assets/pic3.jpeg')},
    {id:4,name:"White sneaker, attraction",price:2000,
    img:require('../../assets/pic4.jpeg')},
    {id:5,name:"watch ahoewa",price:2000,
    img:require('../../assets/pic5.jpeg')},
    {id:6,name:"Cap cat then one to buy",price:2000,
    img:require('../../assets/pic1.jpeg')},
    {id:7,name:"watch ahoewa one sneaker equalizer",
    price:2000,img:require('../../assets/pic1.jpeg')},
    {id:8,name:"watch ahoewa  the helena or the later",
    price:2000,img:require('../../assets/pic1.jpeg')},
  ];


export default function FunirtureScreen({navigation}) {
